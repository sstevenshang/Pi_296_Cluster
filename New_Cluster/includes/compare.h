...
/**
 * The concept Compare is a set of requirements expected by some of the standard library facilities
 * from the user-provided function object types.
 *
 * The return value of the function call operation applied to an object of type Compare,
 * when contextually converted to bool,
 * yields true if the first argument of the call appears before the second in the strict weak ordering relation
 * induced by this Compare type, and false otherwise.
 *
 * Requirements:
 *
 ...
 *
 * Returns:
 *  a negative value if 'a' has a lower virtual address than 'b''s virtual address
 *  a negative value if 'b' has a lower virtual address than 'a''s virtual address
